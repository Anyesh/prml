...
import { centerGramMatrix, kernelPcaFit, kernelPcaProject, kernelPcaTrainingProjections } from './kernelPca.js';
import { gramMatrix, rbfKernelGamma } from '../kernels/index.js';
...
describe('gramMatrix / rbfKernelGamma', () => {
  it('matches an independently computed RBF Gram matrix', () => {
    ...
    const result = gramMatrix(kernel, data);
